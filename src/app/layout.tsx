...
export const metadata: Metadata = {
  ...
  description: "Dashboard profesional de análisis de criptomonedas en tiempo real con gráficos interactivos",
  keywords: "crypto, dashboard, bitcoin, ethereum, análisis, gráficos",
